...
public:
    ...
    explicit Router(const Graph& graph, RoutesInternalData& router_internal_data);
...
template <typename Weight>
Router<Weight>::Router(const Graph& graph, Router<Weight>::RoutesInternalData& router_internal_data)
    : graph_(graph), routes_internal_data_(std::move(router_internal_data)) {
}
